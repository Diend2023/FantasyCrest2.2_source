package org.gif.encoder
{
   ...
   public class LZWEncoder
   {
      ...
      {
         var _loc3_:* = this;
         _loc3_.a_count = this.a_count + 1;
         var _loc4_:* = this.a_count + 1;
         this.accum[_loc4_] = param1;
         if(this.a_count >= 254)
         {
      ...
      public function compress(param1:int, param2:ByteArray) : void
      {
         ...
         do
         {
            ...
            {
               _loc10_ = this;
               _loc10_.free_ent = this.free_ent + 1;
               this.codetab[_loc4_] = this.free_ent + 1;
      ...
      private function nextPixel() : int
      {
         ...
         _loc1_ = this;
         var _loc2_:* = this.remaining - 1;
         _loc1_.remaining = _loc2_;
         _loc1_ = this;
         _loc1_.curPixel = this.curPixel + 1;
         var _loc3_:* = this.pixAry[this.curPixel++];
         return _loc3_ & 0xFF;
      }
      ...
      private function output(param1:int, param2:ByteArray) : void
      {
         ...
         if(this.free_ent > this.maxcode || this.clear_flg)
         {
            if(this.clear_flg)
            {
               _loc3_ = this.g_init_bits;
               this.n_bits = this.g_init_bits;
               this.maxcode = this.MAXCODE(_loc3_);
               this.clear_flg = false;
            }
            else
            {
               _loc3_ = this;
               _loc4_ = this.n_bits + 1;
               _loc3_.n_bits = _loc4_;
