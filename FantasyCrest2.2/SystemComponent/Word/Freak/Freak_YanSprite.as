package SystemComponent.Word.Freak
{
   ...
   public class Freak_YanSprite
   {
      
      public static var $ob:Object = new Object();
      
      public function Freak_YanSprite()
      {
         super();
      }
      ...
      {
         SystemLoading.addTask("File/indexFile/img/freak/yanSprite.png","photo","Freak_YanSprite");
         SystemLoading.addTask("File/indexFile/img/freak/yanSprite.xml","text","Freak_YanSprite");
