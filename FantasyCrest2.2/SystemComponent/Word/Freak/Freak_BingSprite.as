package SystemComponent.Word.Freak
{
   ...
   public class Freak_BingSprite
   {
      
      public static var $ob:Object = new Object();
      
      public function Freak_BingSprite()
      {
         super();
      }
      ...
      {
         SystemLoading.addTask("File/indexFile/img/freak/bingSprite.png","photo","Freak_BingSprite");
         SystemLoading.addTask("File/indexFile/img/freak/bingSprite.xml","text","Freak_BingSprite");
