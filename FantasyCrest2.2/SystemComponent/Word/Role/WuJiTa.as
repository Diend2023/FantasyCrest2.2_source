package SystemComponent.Word.Role
{
   ...
   public class WuJiTa
   {
      ...
      {
         SystemLoading.addTask("File/indexFile/img/role/wujita.png","photo","WuJiTa");
         SystemLoading.addTask("File/indexFile/img/role/wujita.xml","text","WuJiTa");
      ...
      public static function getSkillBuff(param1:SystemGameRole) : void
      {
         ...
         switch(param1.$frameString)
         {
            ...
            case "碎":
               ...
               if(Boolean(param1.hitGameRole) && param1.$frameInt < 11)
               {
                  param1.to(11);
               }
            ...
            case "龟派气功":
               ...
               break;
            case "空中攻击":
               param1.$x += param1.$scaleX * FrameMath.mathFrameToX(param1.$frameInt,2,4,20);
