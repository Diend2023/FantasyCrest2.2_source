package SystemComponent.Word.Role
{
   ...
   public class GeLei
   {
      ...
      {
         SystemLoading.addTask("File/indexFile/img/role/gelei.png","photo","GeLei");
         SystemLoading.addTask("File/indexFile/img/role/gelei.xml","text","GeLei");
