package SystemComponent.Word.Role
{
   ...
   public class YangCongTou
   {
      
      public static var $ob:Object = new Object();
      
      public function YangCongTou()
      {
         super();
      }
      ...
      {
         SystemLoading.addTask("File/indexFile/img/role/yangcongtou.png","photo","YangCongTou");
         SystemLoading.addTask("File/indexFile/img/role/yangcongtou.xml","text","YangCongTou");
