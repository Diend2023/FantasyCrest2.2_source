package SystemComponent.Word.Role
{
   ...
   public class TongRen
   {
      ...
      {
         var _loc1_:int = 0;
         SystemLoading.addTask("File/indexFile/img/role/tongren.png","photo","TongRen");
         SystemLoading.addTask("File/indexFile/img/role/tongren.xml","text","TongRen");
         ...
         SystemLoading.addTask("File/indexFile/sound/role/tongren/star.mp3","sound","tongren_star");
         SystemLoading.addTask("File/indexFile/sound/role/tongren/star2.mp3","sound","tongren_star2");
      ...
      public static function getSkillBuff(param1:SystemGameRole) : void
      {
         ...
         switch(param1.$frameString)
         {
            ...
            case "二刀流":
               ...
               SystemMucisPlay.setMusic = "tongren_shuangdao";
               if(param1.$frameInt == 2 && param1.$skillFrameInt !== param1.$frameInt)
               {
                  ComponentResourcesManage.$Ob["SystemWord"].askElements("skill",{
                     "gox":3,
            ...
            case "幻影乱斩":
               ...
               if(param1.$frameInt == 2 && param1.$skillFrameInt !== param1.$frameInt)
               {
                  SystemMucisPlay.setMusic = "tongren_star";
                  ComponentResourcesManage.$Ob["SystemWord"].askElements("skill",{
                     "ka":[7,10],
                     "name":"TR/Z",
                     "type":"SkillTongRen",
               ...
               {
                  SystemMucisPlay.setMusic = "tongren_star2";
                  ComponentResourcesManage.$Ob["SystemWord"].askElements("skill",{
                     "ka":[1,10],
                     "name":"GJS/Z",
                     "type":"SkillTongRen",
